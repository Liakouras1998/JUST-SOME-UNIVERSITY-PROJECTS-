...
public class Main {
    ...
    private static String trainPath = "lingspam_public\\lemm_stop\\part1";
    private static String testPath = "lingspam_public\\lemm_stop\\part2";
    ...
    private static void printResults(String name, MachineLearning ml, ArrayList<HashSet<String>>[] examples, ArrayList<HashSet<String>> test) {
            ...
            for (HashSet<String> set : examples[i]) {
                ...
                for (HashMap<HashSet<String>, String> map : trainMessages) {
                    if (map.containsKey(set)) {
                        if (map.get(set).startsWith("spm")) n1 += cls;
                        if (!map.get(set).startsWith("spm")) n0 += cls;
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        Bayes b = new Bayes(examples[0], examples[1]);
        ...
        MultinomialNaiveBayes mb = new MultinomialNaiveBayes(trainPath, testPath);
        mb.run();
        System.out.println();
